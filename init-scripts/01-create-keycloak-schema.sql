...
-- Schemat dla modułu Projekty — projekty, serwery, KPI i tabela wersjonowania Alembic
CREATE SCHEMA IF NOT EXISTS projekty;
...
GRANT ALL ON SCHEMA projekty TO postgres;
